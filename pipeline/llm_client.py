...
Supports both Anthropic Claude and Azure OpenAI for flexibility.
"""
...
class AzureOpenAIClient(LLMClient):
    """Azure OpenAI client (legacy support)."""
...
def create_client(provider: str = None) -> LLMClient:
    ...
    Auto-detects provider based on available environment variables if not specified.
    
    Args:
        provider: Either "claude", "azure", or None for auto-detect
    ...
    if provider is None:
        ...
        if os.environ.get('ANTHROPIC_API_KEY'):
            ...
            raise ValueError("No LLM credentials found. Set ANTHROPIC_API_KEY or AZURE_OPENAI_KEY")
